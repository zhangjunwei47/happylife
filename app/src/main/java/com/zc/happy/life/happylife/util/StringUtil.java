...
public final class StringUtil {
    ...
    public static final String EMPTY_STRING = Constants.BLANK_STR;
    ...
    public static String stripHtmlTags(String string) {
        if ((string == null) || Constants.BLANK_STR.equals(string)) {
            return string;
        }
        return htmlTagPattern.matcher(string).replaceAll(Constants.BLANK_STR);
    }
    ...
    public static HashMap<String, String> string2Map(String in,
        ...
        if (isEmpty(delimEntry) || isEmpty(delimKey)) {
            out.put(strip(in), Constants.BLANK_STR);
            return out;
        }
        ...
        while (it.hasNext()) {
            ...
            if (pos > 0) {
                ...
                out.put(strip(entry), Constants.BLANK_STR);
            }
        }
    ...
    public static String collapseWhitespaceNoneBlank(String str) {
        return collapse(str, WHITE_SPACES, Constants.BLANK_STR);
    }
    ...
    public static String[] parseDelimitedList(String list, char delimiter) {
        ...
        String lastToken = Constants.BLANK_STR;
        String word = Constants.BLANK_STR;
        ...
        while (st.hasMoreTokens()) {
            ...
            if (lastToken != null) {
                if (tok.equals(delim)) {
                    ...
                    if (!word.equals(Constants.BLANK_STR))
                        v.add(word);
                    word = Constants.BLANK_STR;
                }
            }
            lastToken = tok;
        }
    ...
    public static String makeSafe(String s) {
        return (s == null) ? Constants.BLANK_STR : s;
    }
    ...
    public static String lastToken(String s, String delimiter) {
        ...
        return (parts.length == 0) ? Constants.BLANK_STR : parts[parts.length - 1];
    }
    ...
    public static String replaceSpanElement(String textWithSpan) {
        ...
        return textWithSpan.replace("<span>", Constants.BLANK_STR).replace("</span>", Constants.BLANK_STR);
    }
    ...
    public static Spanned getLightFromHtml(String str) {
        if (str == null) {
            return Html.fromHtml(Constants.BLANK_STR);
        }
    ...
    public static Spanned getNormalFromHtml(String str) {
        ...
        str = str.replaceAll("<em>", Constants.BLANK_STR);
        str = str.replaceAll("</em>", Constants.BLANK_STR);
        return Html.fromHtml(str);
    }
    ...
    public static String removeLightTag(String str) {
        ...
        str = str.replaceAll("<em>", Constants.BLANK_STR).replaceAll("</em>", Constants.BLANK_STR);
        return str;
    }
    ...
    public static String removeBlankStr(String str) {
        if (str != null && str.length() > 0) {
            ...
            str = m.replaceAll(Constants.BLANK_STR);
